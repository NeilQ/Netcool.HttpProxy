...
namespace Netcool.HttpProxy
{
    internal static class ProxyAdvancedExtensions
    {
        ...
        public static async Task AcceptProxyWebSocketRequest(this HttpContext context, Uri destinationUri)
        {
            ...
            CancellationToken cancellationToken)
        {
            ...
            while (true)
            {
                ...
                {
                    await destination.CloseOutputAsync(WebSocketCloseStatus.EndpointUnavailable, source.CloseStatusDescription,
                        cancellationToken);
                    return;
                }
